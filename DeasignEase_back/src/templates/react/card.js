module.exports = ({ title = 'Card Title', description = 'This is a beautiful card component with modern design.' }) => {
  // Chemin du composant d'aperçu côté frontend
  const preview = '/previews/CardPreview.jsx';
...
module.exports.preview = '/previews/CardPreview.jsx';
